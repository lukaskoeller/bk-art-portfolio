              ...
              <div className="info-bar">
                <div className="info-bar-in">
                  ...
                  <div className="info-bar-in__misc">
                    <button className="btn btn--light info-bar-in__btn" onClick={() => this.shareEvent('https://bk-art.netlify.com', this.state.project.frontmatter.title, 'Gemälde von Bärbel Köller')}>Teilen</button>
